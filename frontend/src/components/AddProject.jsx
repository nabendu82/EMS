...
const AddProject = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            const response = await axios.post('http://localhost:3000/api/project/add', project, {
            ...
            console.error(error)
            alert(error?.response?.data?.error || 'Could not add project')
        }
    }
            ...
            <div className="mx-auto max-w-2xl">
                <div className="mb-8">
                    <div className="mb-2 flex items-center gap-3">
                        ...
                        <h2 className="text-3xl font-bold text-gray-800">Add Project</h2>
                    </div>
                    <p className="ml-16 text-gray-600">
                        Create projects (e.g. &quot;Department – IT&quot;) then assign them to employees on Edit Employee.
                    </p>
                </div>
                ...
                <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-xl">
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="pt-4">
                            <button
                                type="submit"
                                className="w-full transform rounded-lg bg-gradient-to-r from-green-600 to-green-500 py-4 px-6 text-lg font-semibold text-white shadow-md transition-all duration-200 hover:scale-[1.02] hover:from-green-700 hover:to-green-600 hover:shadow-lg active:scale-[0.98] focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                            >
                                Add Project
                            </button>
                        </div>
